            ...
            contents: [
                {
                    parts: [
                        {
                            text: `${TASK_DECOMPOSITION_SYSTEM_PROMPT}\n\n---\n\nUser input: ${buildUserMessage(userInput, existingGroups, language)}`,
                        },
                    ],
                },
            ],
            ...
            contents: [
                {
                    parts: [
                        {
                            text: `${BRANCH_DECOMPOSITION_SYSTEM_PROMPT}\n\n---\n\nUser input: ${buildBranchUserMessage(context, existingGroups, language)}`,
                        },
                    ],
                },
            ],
